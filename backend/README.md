...
## Project Structure
    ...
    ├── testapiautoteammemb_83215  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_83215`
...
2. Clone this repo and `cd testapiautoteammemb_83215`
